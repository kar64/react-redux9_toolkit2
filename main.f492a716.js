...
},{"react-dom":"NKHc"}],"Mzip":[function(require,module,exports) {
module.exports = "react.ec1737a3.png";
},{}],"uFfX":[function(require,module,exports) {
"use strict";
...
var _react2 = _interopRequireDefault(require("../images/react.png"));
...
},{"react":"n8MK","../images/react.png":"Mzip"}],"Kt3v":[function(require,module,exports) {

},{}],"eF9w":[function(require,module,exports) {
"use strict";
...
},{"react":"n8MK","./footer.scss":"Kt3v"}],"rUC0":[function(require,module,exports) {
"use strict";
...
function createStore(reducer, preloadedState, enhancer) {
  ...
  function dispatch(action) {
    ...
    if (typeof action.type !== "string") {
      throw new Error("production" === "production" ? formatProdErrorMessage(17) : `Action "type" property must be a string. Instead, the actual type was: '${kindOf(action.type)}'. Value was: '${action.type}' (stringified)`);
    }
    if (isDispatching) {
...
},{}],"ifEC":[function(require,module,exports) {
"use strict";
...
function finalizeProperty(rootScope, parentState, targetObject, prop, childValue, rootPath, targetIsSet) {
  if ("production" !== "production" && childValue === targetObject) die(5);
...
arrayTraps.deleteProperty = function (state, prop) {
  if ("production" !== "production" && isNaN(parseInt(prop))) die(13);
  return arrayTraps.set.call(this, state, prop, void 0);
};
arrayTraps.set = function (state, prop, value) {
  if ("production" !== "production" && prop !== "length" && isNaN(parseInt(prop))) die(14);
...
},{}],"JJAS":[function(require,module,exports) {
"use strict";
...
},{}],"tL4q":[function(require,module,exports) {
"use strict";
...
},{}],"qDkt":[function(require,module,exports) {
...
var createDraftSafeSelector = exports.createDraftSafeSelector = createDraftSafeSelectorCreator(_reselect.weakMapMemoize);
...
function createAction(type, prepareAction) {
  function actionCreator(...args) {
    if (prepareAction) {
      ...
      if (!prepared) {
        throw new Error("production" === "production" ? formatProdErrorMessage(0) : "prepareAction did not return an object");
      }
      return {
        type,
...
function emplace(map, key, handler) {
  ...
  if (!handler.insert) throw new Error("production" === "production" ? formatProdErrorMessage(10) : "No insert provided for key not already in map");
    ...
    return ({
      ...
      return next => action => {
        ...
        measureUtils.measureTime(() => {
          ...
          tracker = track(state);
          if (result.wasMutated) {
            throw new Error("production" === "production" ? formatProdErrorMessage(19) : `A state mutation was detected between dispatches, in the path '${result.path || ""}'.  This may cause incorrect behavior. (https://redux.js.org/style-guide/style-guide#do-not-mutate-state)`);
          }
        });
        ...
        measureUtils.measureTime(() => {
          ...
          tracker = track(state);
          if (result.wasMutated) {
            throw new Error("production" === "production" ? formatProdErrorMessage(20) : `A state mutation was detected inside a dispatch, in the path: ${result.path || ""}. Take a look at the reducer(s) handling the action ${stringify2(action)}. (https://redux.js.org/style-guide/style-guide#do-not-mutate-state)`);
          }
        });
...
function configureStore(options) {
  ...
  if (typeof reducer === "function") {
    ...
    throw new Error("production" === "production" ? formatProdErrorMessage(1) : "`reducer` is a required argument, and must be a function or an object of functions that can be passed to combineReducers");
  }
  if (!IS_PRODUCTION && middleware && typeof middleware !== "function") {
    throw new Error("production" === "production" ? formatProdErrorMessage(2) : "`middleware` field must be a callback");
  }
  let finalMiddleware;
  if (typeof middleware === "function") {
    finalMiddleware = middleware(getDefaultMiddleware);
    if (!IS_PRODUCTION && !Array.isArray(finalMiddleware)) {
      throw new Error("production" === "production" ? formatProdErrorMessage(3) : "when using a middleware builder function, an array of middleware must be returned");
    }
  } else {
    finalMiddleware = getDefaultMiddleware();
  }
  if (!IS_PRODUCTION && finalMiddleware.some(item => typeof item !== "function")) {
    throw new Error("production" === "production" ? formatProdErrorMessage(4) : "each middleware provided to configureStore must be a function");
  }
  ...
  if (!IS_PRODUCTION && enhancers && typeof enhancers !== "function") {
    throw new Error("production" === "production" ? formatProdErrorMessage(5) : "`enhancers` field must be a callback");
  }
  let storeEnhancers = typeof enhancers === "function" ? enhancers(getDefaultEnhancers) : getDefaultEnhancers();
  if (!IS_PRODUCTION && !Array.isArray(storeEnhancers)) {
    throw new Error("production" === "production" ? formatProdErrorMessage(6) : "`enhancers` callback must return an array");
  }
  if (!IS_PRODUCTION && storeEnhancers.some(item => typeof item !== "function")) {
    throw new Error("production" === "production" ? formatProdErrorMessage(7) : "each enhancer provided to configureStore must be a function");
  }
...
function executeReducerBuilderCallback(builderCallback) {
  ...
  const builder = {
    addCase(typeOrActionCreator, reducer) {
      if ("production" !== "production") {
        if (actionMatchers.length > 0) {
          throw new Error("production" === "production" ? formatProdErrorMessage(26) : "`builder.addCase` should only be called before calling `builder.addMatcher`");
        }
        if (defaultCaseReducer) {
          throw new Error("production" === "production" ? formatProdErrorMessage(27) : "`builder.addCase` should only be called before calling `builder.addDefaultCase`");
        }
      }
      const type = typeof typeOrActionCreator === "string" ? typeOrActionCreator : typeOrActionCreator.type;
      if (!type) {
        throw new Error("production" === "production" ? formatProdErrorMessage(28) : "`builder.addCase` cannot be called with an empty action type");
      }
      if (type in actionsMap) {
        throw new Error("production" === "production" ? formatProdErrorMessage(29) : `\`builder.addCase\` cannot be called with two reducers for the same action type '${type}'`);
      }
    ...
    addMatcher(matcher, reducer) {
      if ("production" !== "production") {
        if (defaultCaseReducer) {
          throw new Error("production" === "production" ? formatProdErrorMessage(30) : "`builder.addMatcher` should only be called before calling `builder.addDefaultCase`");
        }
      }
      actionMatchers.push({
        matcher,
    ...
    addDefaultCase(reducer) {
      if ("production" !== "production") {
        if (defaultCaseReducer) {
          throw new Error("production" === "production" ? formatProdErrorMessage(31) : "`builder.addDefaultCase` can only be called once");
        }
      }
...
function createReducer(initialState, mapOrBuilderCallback) {
  if ("production" !== "production") {
    if (typeof mapOrBuilderCallback === "object") {
      throw new Error("production" === "production" ? formatProdErrorMessage(8) : "The object notation for `createReducer` has been removed. Please use the 'builder callback' notation instead: https://redux-toolkit.js.org/api/createReducer");
    }
  }
      ...
      if (caseReducer) {
        if ((0, _immer.isDraft)(previousState)) {
          ...
          if (result === void 0) {
            ...
            throw new Error("production" === "production" ? formatProdErrorMessage(9) : "A case reducer on a non-draftable value must not return undefined");
          }
          return result;
        } else {
...
function buildCreateSlice({
  ...
  return function createSlice2(options) {
    ...
    if (!name) {
      throw new Error("production" === "production" ? formatProdErrorMessage(11) : "`name` is a required option for createSlice");
    }
    ...
    const contextMethods = {
      addCase(typeOrActionCreator, reducer) {
        const type = typeof typeOrActionCreator === "string" ? typeOrActionCreator : typeOrActionCreator.type;
        if (!type) {
          throw new Error("production" === "production" ? formatProdErrorMessage(12) : "`context.addCase` cannot be called with an empty action type");
        }
        if (type in context.sliceCaseReducersByType) {
          throw new Error("production" === "production" ? formatProdErrorMessage(13) : "`context.addCase` cannot be called with two reducers for the same action type: " + type);
        }
    ...
    function buildReducer() {
      if ("production" !== "production") {
        if (typeof options.extraReducers === "object") {
          throw new Error("production" === "production" ? formatProdErrorMessage(14) : "The object notation for `createSlice.extraReducers` has been removed. Please use the 'builder callback' notation instead: https://redux-toolkit.js.org/api/createSlice");
        }
      }
      ...
      selectSlice(state) {
        ...
        if (typeof sliceState === "undefined") {
          if (this !== slice) {
            ...
            throw new Error("production" === "production" ? formatProdErrorMessage(15) : "selectSlice returned undefined for an uninjected slice reducer");
          }
        }
        return sliceState;
      },
  ...
  function wrapper(rootState, ...args) {
    ...
    if (typeof sliceState === "undefined") {
      if (injected) {
        ...
        throw new Error("production" === "production" ? formatProdErrorMessage(16) : "selectState returned undefined for an uninjected slice reducer");
      }
    }
...
var createSlice = exports.createSlice = buildCreateSlice();
...
function handleNormalReducerDefinition({
  ...
  if ("reducer" in maybeReducerWithPrepare) {
    if (createNotation && !isCaseReducerWithPrepareDefinition(maybeReducerWithPrepare)) {
      throw new Error("production" === "production" ? formatProdErrorMessage(17) : "Please use the `create.preparedReducer` notation for prepared action creators with the `create` notation.");
    }
...
function handleThunkCaseReducerDefinition({
  ...
  if (!cAT) {
    throw new Error("production" === "production" ? formatProdErrorMessage(18) : "Cannot use `create.asyncThunk` in the built-in `createSlice`. Use `buildCreateSlice({ creators: { asyncThunk: asyncThunkCreator } })` to create a customised version of `createSlice`.");
  }
  const {
    payloadCreator,
    fulfilled,
...
var assertFunction = (func, expected) => {
  if (typeof func !== "function") {
    throw new Error("production" === "production" ? formatProdErrorMessage(32) : `${expected} is not a function`);
  }
};
var noop2 = () => {};
...
var getListenerEntryPropsFrom = options => {
  ...
  if (type) {
    ...
    throw new Error("production" === "production" ? formatProdErrorMessage(21) : "Creating or removing a listener requires one of the known fields for matching an action");
  }
...
var createListenerEntry = options => {
  ...
  const entry = {
    ...
    unsubscribe: () => {
      throw new Error("production" === "production" ? formatProdErrorMessage(22) : "Unsubscribe not initialized");
    }
  };
  return entry;
};
...
var addListener = exports.addListener = createAction(`${alm}/add`);
var clearAllListeners = exports.clearAllListeners = createAction(`${alm}/removeAll`);
var removeListener = exports.removeListener = createAction(`${alm}/remove`);
  ...
  const middleware = api => next => action => {
    ...
    const getOriginalState = () => {
      if (originalState === INTERNAL_NIL_TOKEN) {
        throw new Error("production" === "production" ? formatProdErrorMessage(23) : `${alm}: getOriginalState can only be called synchronously`);
      }
      ...
      if (typeof result === "undefined") {
        ...
        if (reducer) {
          ...
          if (typeof reducerResult === "undefined") {
            throw new Error("production" === "production" ? formatProdErrorMessage(24) : `The slice reducer for key "${prop.toString()}" returned undefined when called for selector(). If the state passed to the reducer is undefined, you must explicitly return the initial state. The initial state may not be undefined. If you don't want to set a value for this reducer, you can use null instead of undefined.`);
          }
...
var original = state => {
  if (!isStateProxy(state)) {
    throw new Error("production" === "production" ? formatProdErrorMessage(25) : "original must be used on state Proxy");
  }
...
},{"redux":"rUC0","immer":"ifEC","reselect":"JJAS","redux-thunk":"tL4q","process":"qDkt"}],"yVDW":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resetCount = exports.mincrement = exports.mdecrement = exports.increment = exports.decrement = exports.counterSlice = exports.counterReducer = void 0;
...
var counterSlice = exports.counterSlice = (0, _toolkit.createSlice)({
  ...
  reducers: {
    ...
    mincrement: function mincrement(state, action) {
      state.count += action.payload;
    },
    mdecrement: function mdecrement(state, action) {
      state.count -= action.payload;
    }
    // resetCount:(state)=>{
    //     state.count=10;
  ...
  extraReducers: function extraReducers(builder) {
    builder.addCase('destination/resetDestination', function (state) {
      state.count = 10;
    });
  }
});
var _counterSlice$actions = counterSlice.actions,
  increment = exports.increment = _counterSlice$actions.increment,
  decrement = exports.decrement = _counterSlice$actions.decrement,
  mincrement = exports.mincrement = _counterSlice$actions.mincrement,
  mdecrement = exports.mdecrement = _counterSlice$actions.mdecrement,
  resetCount = exports.resetCount = _counterSlice$actions.resetCount;
var counterReducer = exports.counterReducer = counterSlice.reducer;
},{"@reduxjs/toolkit":"UXHM"}],"qfT6":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resetDestination = exports.destinationSlice = exports.destinationReducer = exports.destinationClicked = void 0;
var _toolkit = require("@reduxjs/toolkit");
var initialState = {
  dest: [{
    name: 'Hong Kong',
...
var destinationSlice = exports.destinationSlice = (0, _toolkit.createSlice)({
  name: 'destination',
  initialState: initialState,
  reducers: {
    destinationClicked: function destinationClicked(state, action) {
      state.destinationSelect = action.payload;
    },
    resetDestination: function resetDestination(state, action) {
      // console.log(action);
      state.destinationSelect = null;
    }
  }
});
var destinationReducer = exports.destinationReducer = destinationSlice.reducer;
var _destinationSlice$act = destinationSlice.actions,
  destinationClicked = exports.destinationClicked = _destinationSlice$act.destinationClicked,
  resetDestination = exports.resetDestination = _destinationSlice$act.resetDestination;
},{"@reduxjs/toolkit":"UXHM"}],"tIDN":[function(require,module,exports) {
"use strict";
...
var _toolkit = require("@reduxjs/toolkit");
var _counterSlice = require("./slice/counterSlice");
var _destinationSlice = require("./slice/destinationSlice");
var store = exports.store = (0, _toolkit.configureStore)({
  reducer: {
    counterStore: _counterSlice.counterReducer,
    destinationStore: _destinationSlice.destinationReducer
  }
});
...
// })
// console.log(store.getState());
},{"@reduxjs/toolkit":"UXHM","./slice/counterSlice":"yVDW","./slice/destinationSlice":"qfT6"}],"AO6Y":[function(require,module,exports) {
/**
 * @license React
...
},{"react":"n8MK"}],"NLov":[function(require,module,exports) {
'use strict';
...
},{"./cjs/use-sync-external-store-with-selector.production.min.js":"AO6Y"}],"mHW4":[function(require,module,exports) {
"use strict";
...
function wrapMapToPropsFunc(mapToProps, methodName) {
  return function initProxySelector(dispatch, {
    ...
    proxy.mapToProps = function detectFactoryAndVerify(stateOrDispatch, ownProps) {
      ...
      if ("production" !== "production") verifyPlainObject(props, displayName, methodName);
      return props;
    };
    return proxy;
  };
  ...
  return function initMergePropsProxy(dispatch, {
    ...
    return function mergePropsProxy(stateProps, dispatchProps, ownProps) {
      ...
      if (hasRunOnce) {
        ...
        if ("production" !== "production") verifyPlainObject(mergedProps, displayName, "mergeProps");
      }
      return mergedProps;
    };
  };
...
},{"react":"n8MK","use-sync-external-store/with-selector.js":"NLov"}],"PTxm":[function(require,module,exports) {
"use strict";
...
var _counterSlice = require("../redux/slice/counterSlice");
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function (e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != typeof e && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && Object.prototype.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
...
var Counter = exports.Counter = function Counter() {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("h1", {
    ...
    onChange: function onChange(e) {
      setVal(Number(e.target.value) ? Number(e.target.value) : 1);
    }
  }), /*#__PURE__*/_react.default.createElement("button", {
    type: "button",
    className: "btn btn-success",
    onClick: function onClick() {
      return dispatch((0, _counterSlice.mincrement)(userValue));
    }
  }, "+"), /*#__PURE__*/_react.default.createElement("button", {
    type: "button",
    className: "btn btn-danger",
    onClick: function onClick() {
      return dispatch((0, _counterSlice.mdecrement)(userValue));
    }
  }, "-"))));
};
},{"react":"n8MK","react-redux":"mHW4","../redux/slice/counterSlice":"yVDW"}],"qDNt":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.DestinationList = void 0;
var _react = _interopRequireDefault(require("react"));
var _reactRedux = require("react-redux");
var _destinationSlice = require("../redux/slice/destinationSlice");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var DestinationList = exports.DestinationList = function DestinationList() {
  var dest = (0, _reactRedux.useSelector)(function (state) {
    return state.destinationStore.dest;
  });
  var dispatch = (0, _reactRedux.useDispatch)();
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, dest.map(function (item, index) {
    return /*#__PURE__*/_react.default.createElement("div", {
      style: {
        display: 'flex',
      ...
      className: "btn btn-success",
      onClick: function onClick() {
        return dispatch((0, _destinationSlice.destinationClicked)(item));
      }
    }, "Details"));
  }));
};
},{"react":"n8MK","react-redux":"mHW4","../redux/slice/destinationSlice":"qfT6"}],"zto6":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.DestinationFact = void 0;
var _react = _interopRequireDefault(require("react"));
var _reactRedux = require("react-redux");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var DestinationFact = exports.DestinationFact = function DestinationFact() {
  var fact = (0, _reactRedux.useSelector)(function (state) {
    return state.destinationStore.destinationSelect;
  });
  if (fact) {
    return /*#__PURE__*/_react.default.createElement("div", {
      className: "text-center border"
    }, /*#__PURE__*/_react.default.createElement("h1", null, fact.name), /*#__PURE__*/_react.default.createElement("h3", null, fact.fact), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement("h4", null, "Days Recommened : ", fact.days));
  } else {
    return null;
  }
};
},{"react":"n8MK","react-redux":"mHW4"}],"Q5sB":[function(require,module,exports) {
"use strict";
...
var Reset = exports.Reset = function Reset() {
  ...
  var res = function res() {
    dispatch((0, _destinationSlice.resetDestination)());
    // dispatch(resetCount());
  };
...
},{"react":"n8MK","react-redux":"mHW4","../redux/slice/destinationSlice":"qfT6","../redux/slice/counterSlice":"yVDW"}],"WoLR":[function(require,module,exports) {
"use strict";
...
var _DestinationList = require("./components/DestinationList");
var _DestinationFact = require("./components/DestinationFact");
...
var App = function App() {
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactRedux.Provider, {
    store: _store.store
  }, /*#__PURE__*/_react.default.createElement(_Header.Header, null), /*#__PURE__*/_react.default.createElement(_Reset.Reset, null), /*#__PURE__*/_react.default.createElement(_Counter.Counter, null), /*#__PURE__*/_react.default.createElement(_DestinationList.DestinationList, null), /*#__PURE__*/_react.default.createElement(_DestinationFact.DestinationFact, null), /*#__PURE__*/_react.default.createElement(_Footer.Footer, null)));
};
...
},{"react":"n8MK","react-dom":"NKHc","react-dom/client":"NdAl","./layout/Header":"uFfX","./layout/Footer":"eF9w","./redux/store":"tIDN","react-redux":"mHW4","./components/Counter":"PTxm","./components/DestinationList":"qDNt","./components/DestinationFact":"zto6","./components/Reset":"Q5sB"}]},{},["WoLR"], null)
//# sourceMappingURL=/main.f492a716.js.map